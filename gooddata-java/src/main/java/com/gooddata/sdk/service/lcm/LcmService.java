...
public class LcmService extends AbstractService {
     ...
     * @return first page of list of lcm entities or empty list
     */
     ...
     * @return first page of list of lcm entitiesor empty list
     */
     ...
     * @return requested page of list of lcm entities or empty list
     */
